...
이 접근 방식으로의 운영상 조정은 데이터 센터 2및 3의 코어 서버를 복구의 시작 지점으로 호스팅 하는 것입니다. 정상적인 작동 중에 이러한 여분의 코어 서버는 [*팔로워 전용*](../create-a-new-causal-cluster.md#4235-팔로워-전용-인스턴스의-바이어스-클러스터-리더십)으로 구성되어야 합니다.
